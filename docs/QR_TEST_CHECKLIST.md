...
| 4 | Donate | https://donorbox.org/help-penetrate-the-darkness | twizted-qr-codes.html (card 4), all page navs | `donate-qr-2026.png` | ⚠️ Needs scan/regeneration check | ⬜ No | Working donation URL is Donorbox. Test-scan the QR image; if it still points to the old dead donation path, regenerate it before printing. |
